...
<div>
	<div class="container">
		...
		<div class="form-group">
			<label>Name of book</label><input type="text" name="book_name"
				class="form-control" id="inputEmail" placeholder="Name of book" required>
		</div>
		<div class="form-group">
			<label>Author of book</label><input type="text" name="book_author"
				class="form-control" id="inputEmail" placeholder="Author of book" required>
		</div>
		<div class="form-group">
			<label>Price of book</label><input type="text" name="book_price"
				class="form-control" id="inputEmail" placeholder="Price of book" required>
		</div>
		<div class="form-group">
			<label>ISBN code of book</label><input type="text" name="ISBN_code"
